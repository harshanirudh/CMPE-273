...
DELIMITER $$
CREATE DEFINER=`admin`@`%` PROCEDURE `SP_Add_New_Restaurant`(in r_name varchar(50),in r_add varchar(120), in r_city varchar(40),in r_state varchar(49),in r_zip varchar(5),in r_country varchar(40),in r_email varchar(60),in r_pass char(128),out id int)
BEGIN
